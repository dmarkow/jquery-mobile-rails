...
This will jQuery Mobile's javascripts, stylesheets and images available to your app.
...
jQuery Mobile Rails gem versions will align with jQuery Mobile version numbering, with the most recent gem always providing the current stable release of jQuery Mobile.
